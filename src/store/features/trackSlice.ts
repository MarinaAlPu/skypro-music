...
export const { setCurrentTrack, setCurrentPlaylist, setIsPlay, setNextTrack, setPrevTrack, toggleIsShuffle, setAllTracks, setFetchError, setFetchIsLoading } = trackSlice.actions;
